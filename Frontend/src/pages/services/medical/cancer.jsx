...
const STORY = [
    "Cancer remains one of the leading causes of death in India, often exacerbated by late diagnosis and the high cost of specialized treatment. For families with limited resources, a cancer diagnosis can be devastating both emotionally and financially.",
    "Our 'Cancer Care & Support' initiative is dedicated to ensuring that no one has to fight this battle alone. We focus on bridging the gap by providing financial aid, facilitating access to quality healthcare, and promoting the importance of early detection.",
    "Your contribution is a beacon of hope. By donating today, you are helping us provide life-saving treatments, essential medications, and a support system that empowers patients to face cancer with strength and dignity."
];
                        ...
                        <article className="cancer-campaign-card">
                            ...
                            <div className="cancer-campaign-body">
                                ...
                                <div className="cancer-campaign-actions">
                                    <Link to="/donate" className="cancer-campaign-btn cancer-campaign-btn-primary">
                                        Donate Now
                                    </Link>
                                    <button
                                        type="button"
                        ...
                        <section className="cancer-section-card cancer-faq-section">
                            ...
                            <div className="cancer-faq-list">
                                {FAQS.map((faq, index) => {
                                    ...
                                    return (
                                        <article key={faq.question} className={`cancer-faq-item ${isOpen ? "open" : ""}`}>
                                            <button
                                                type="button"
